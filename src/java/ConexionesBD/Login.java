...
public class Login {
    ...
    public boolean existeUsuario(String usuario) {
        ...
        try {
            ...
            String s = "select * from usuario where nombre='" + usuario + "'  ";
    ...
    public boolean claveCorrecta(String usuario, String clave) {
        ...
        try {
            c = PollDeConexiones.getInstance().getConnection();
            String s = "select clave from usuario where nombre='" + usuario + "' ";
            PreparedStatement p = c.prepareStatement(s);
     ...
     public int getTipoUsuario(String usuario) {
        ...
        try {
            c = PollDeConexiones.getInstance().getConnection();
            String s = "select tipo_usuario from usuario where nombre='" + usuario + "'  ";
            PreparedStatement p = c.prepareStatement(s);
