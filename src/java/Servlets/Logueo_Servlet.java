            ...
            if (obj.existeUsuario(u)) // Se verifica si el Usuario existe
            {
                if (obj.claveCorrecta(u, c))//se llama al metodo para verificar la contraseña
                {
                    if (obj.getTipoUsuario(u) == 1) {
                        ...
                        response.sendRedirect("Dashboard_RRHH.jsp"); // se redirecciona al formulario o pagina JSP deseada    
                    } else {
                            ...
                            response.sendRedirect("Buzon_Sugerencia.jsp"); // se redirecciona al formulario o pagona JSP deseada                       
                        }
                } else {
                ...
                String error = "El usuario debe ser anonimo";
                response.sendRedirect("Login.jsp?msj=" + error);
